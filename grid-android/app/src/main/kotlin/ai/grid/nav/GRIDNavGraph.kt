...
fun GRIDNavGraph(modifier: Modifier = Modifier) {
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.Session.route)  { SessionScreen(onNavigateToStage = { navController.navigate(Screen.Stage.route) }) }
            composable(Screen.Projects.route) { ProjectsScreen(onNavigateToSession = { navController.navigate(Screen.Session.route) }) }
